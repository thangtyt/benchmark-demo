...
* Added socketTimeoutMS and connectTimeoutMS to socket options for repl_set.js and serverMongo.js
...
* Correctly emit errors from serverMongo.js only wrapping errors that are strings
